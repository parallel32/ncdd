 ...
 */
class ReferenceSustainingMember extends Reference {
	
	public $type = 'NEW SUSTAINING MEMBER REFERENCE';
	public $class = 'ReferenceSustainingMember';
	private $maxSubmissions = 4;
