...
class UploadWrapperMongo
{
    ...
    /**
	 * save file and corresponding document to mongo
	 * @param $file 	file	file object passed in by reference so that the insert Id can be added
	 *							and the urls can be made
	 */
	public function saveFile(&$file,$replace=false) {
        // first delete any files previously associated with the parent Object
        ...
        $modelObj = $file->instantiateParent($this->app);
        $modelObj->saveEdit();
        return true;
    }
