...
$app->register(new Saw\Provider\View\ViewServiceProvider(), array(
    'saw.view_path'      => __DIR__.'/views/admin/',
    'saw.layout_path'    => __DIR__.'/views/_layouts/admin/',
	'saw.element_path'   => __DIR__.'/views/_elements/admin/'
));

//////////////////////////////
// Register Session Service //
//////////////////////////////
require_once __DIR__.'/bootstrap.admin.constants.php';
