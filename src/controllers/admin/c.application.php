...
$app->get('/renewalsautoseed', function (Request $request) use ($app) {
	...
	$cnt = 0;
    $final_arr = array();
    // add the newly identified people form Hunter's list 3/2/2017
    $new_arr[] = new \MongoId('53a9c5ad54fe0b3a58dadea2');
	$new_arr[] = new \MongoId('562fb0a81f1d75cb3f9ffbfc');
	$new_arr[] = new \MongoId('5627ff0fa6ec61b1052aa5d1');
	$new_arr[] = new \MongoId('56296a781f1d75b678131858');
	$new_arr[] = new \MongoId('56393ff0a6ec61266ee770ff');
	$new_arr[] = new \MongoId('562a97851f1d75020c131858');
	$new_arr[] = new \MongoId('56216c0054fe0b4b2b742c1d');
	$new_arr[] = new \MongoId('565dbe54a6ec61ab0beaa08b');
	$new_arr[] = new \MongoId('5630e6561f1d756e5e9ffbfd');
	$new_arr[] = new \MongoId('56251da81f1d75000f131854');
	$new_arr[] = new \MongoId('562657401f1d75374d131858');
	$new_arr[] = new \MongoId('5625474c54fe0bd102742c1c');
	$new_arr[] = new \MongoId('534ee3b6a6ec61c712632fc9');
	$new_arr[] = new \MongoId('53a992cfa6ec61eb1ee40908');
	$new_arr[] = new \MongoId('56290d6e54fe0bbe2c742c1c');
	$new_arr[] = new \MongoId('57239f88a6ec61b5075d22e7');
	$new_arr[] = new \MongoId('561e73f1a6ec61d72dabe932');
	$new_arr[] = new \MongoId('56461fdea6ec61f65895d1e9');
	$new_arr[] = new \MongoId('562918d5a6ec61b5232aa5d1');
	$new_arr[] = new \MongoId('562d49be1f1d75444e9ffbfd');
	$new_arr[] = new \MongoId('570fb40054fe0bd82011ee6f');
	$new_arr[] = new \MongoId('5625191fa6ec6189052aa5d1');
	$new_arr[] = new \MongoId('5621498ca6ec61cb27abe932');
	$new_arr[] = new \MongoId('564133b8a6ec61207195d1e9');
	$new_arr[] = new \MongoId('56267a021f1d751766131858');
	$new_arr[] = new \MongoId('56251fb71f1d75141213185a');
	$new_arr[] = new \MongoId('5707d2b354fe0b7172fcf164');
	$new_arr[] = new \MongoId('571fa09654fe0b8a5d4b9604');
	$new_arr[] = new \MongoId('5441439da6ec61210f523636');
	$new_arr[] = new \MongoId('5630d87b54fe0b571e742c1c');
	$new_arr[] = new \MongoId('562eb7c254fe0bdb02742c1d');
	$new_arr[] = new \MongoId('561005ae1f1d75ea612c46f8');
	$new_arr[] = new \MongoId('5730a6131f1d758d61b576af');
	$new_arr[] = new \MongoId('563242d6a6ec616c34fbe2b3');
	$new_arr[] = new \MongoId('57211cfca6ec61ea7c5d22e7');
	$new_arr[] = new \MongoId('562639b01f1d750a3d131858');
	$new_arr[] = new \MongoId('57040e521f1d75b63459eb46');
	$new_arr[] = new \MongoId('577bacfda6ec61e446457571');
	$new_arr[] = new \MongoId('5646361c1f1d752b134b0ce8');
	$new_arr[] = new \MongoId('564612451f1d75f9754b0ce8');
	$new_arr[] = new \MongoId('57040bc31f1d75f42a59eb46');
	$new_arr[] = new \MongoId('533092b154fe0b4d33586a10');
	$new_arr[] = new \MongoId('5208d62c9afe0b53323e91c8');
	$new_arr[] = new \MongoId('5705a267a6ec61056fe12fd4');
	$new_arr[] = new \MongoId('56211b88a6ec619608abe932');
	$new_arr[] = new \MongoId('560ee2561f1d750a312c46f8');
	$new_arr[] = new \MongoId('5208d64b9afe0b53323e93fb');
	$new_arr[] = new \MongoId('56212454a6ec61d80cabe933');
	$new_arr[] = new \MongoId('55168b9a1f1d75c355070510');
	$new_arr[] = new \MongoId('570826c91f1d750b2759eb46');
	$new_arr[] = new \MongoId('56392c9054fe0be372742c1c');
	$new_arr[] = new \MongoId('5208d5f89afe0b53323e8e36');
	$new_arr[] = new \MongoId('562a479ea6ec61524c2aa5d3');
	$new_arr[] = new \MongoId('55a7c0d21f1d75c3652c46f8');
	$new_arr[] = new \MongoId('5632477d54fe0b2d5d742c1c');
	$new_arr[] = new \MongoId('565d08901f1d75d31bd3e88f');
	$new_arr[] = new \MongoId('5208d6299afe0b53323e919a');
	$new_arr[] = new \MongoId('5639271e54fe0bd26d742c1c');
	$new_arr[] = new \MongoId('5632297154fe0b214b742c1d');
	$new_arr[] = new \MongoId('5706ad01a6ec61727fe12fd4');
	$new_arr[] = new \MongoId('56253763a6ec6178202aa5d2');
	$new_arr[] = new \MongoId('5645e9561f1d75f05d4b0ce8');
	$new_arr[] = new \MongoId('571502b31f1d75004f49b448');
	$new_arr[] = new \MongoId('5722586f1f1d7524429d8ea1');
	$new_arr[] = new \MongoId('5630fab754fe0b3234742c1c');
	$new_arr[] = new \MongoId('562a5ab854fe0b1668742c1c');
	$new_arr[] = new \MongoId('5639584654fe0bbc13742c1c');
	$new_arr[] = new \MongoId('56257c83a6ec61f35b2aa5d1');
	$new_arr[] = new \MongoId('563b97fa1f1d75dd3f708f14');
	$new_arr[] = new \MongoId('53f2491a1f1d75b5489a4d3d');
	$new_arr[] = new \MongoId('5649fd9f54fe0b8a15742c1f');
	$new_arr[] = new \MongoId('560d452a54fe0bd865742c1d');
	$new_arr[] = new \MongoId('574e389a54fe0bc557ae8315');
	$new_arr[] = new \MongoId('5616c2e654fe0b1555742c1c');
	$new_arr[] = new \MongoId('5637f04254fe0b892c742c1c');
	$new_arr[] = new \MongoId('52654dd51f1d75f349086a49');
	$new_arr[] = new \MongoId('5632a158a6ec61ea0afbe2b2');
	$new_arr[] = new \MongoId('572282db1f1d752c549d8ea1');
	$new_arr[] = new \MongoId('574dce36a6ec618125af4b86');
	$new_arr[] = new \MongoId('563288f754fe0bea1d742c1e');
	$new_arr[] = new \MongoId('562fcbb154fe0beb0f742c1d');
	$new_arr[] = new \MongoId('5625569b54fe0b220a742c1c');
	$new_arr[] = new \MongoId('5437e8b554fe0b662652a1b7');
	$new_arr[] = new \MongoId('5674a742a6ec61f208dfe076');
	$new_arr[] = new \MongoId('5208d6529afe0b53323e946a');
	$new_arr[] = new \MongoId('56368411a6ec61d735e770ff');
	$new_arr[] = new \MongoId('5208d5c39afe0b53323e8a81');
	$new_arr[] = new \MongoId('5208d5f59afe0b53323e8e09');
	$new_arr[] = new \MongoId('5208d5c19afe0b53323e8a5f');
	$new_arr[] = new \MongoId('5625174e1f1d75820a131859');
	$new_arr[] = new \MongoId('5208d6889afe0b53323e9832');
	$new_arr[] = new \MongoId('5682eadb1f1d75872faa2f53');
	$new_arr[] = new \MongoId('53fb4eab54fe0b1a5652a1b2');
	$new_arr[] = new \MongoId('570526551f1d75ff5759eb46');
	$new_arr[] = new \MongoId('562abff91f1d75791e13185b');
	$new_arr[] = new \MongoId('562a4570a6ec61484e2aa5d1');
	$new_arr[] = new \MongoId('563a734b54fe0bc527742c1c');
	$new_arr[] = new \MongoId('563b8a3aa6ec619949e770ff');
	$new_arr[] = new \MongoId('570ea50854fe0b3a6a11ee71');
	$new_arr[] = new \MongoId('5679815454fe0b9055742c1c');
	$new_arr[] = new \MongoId('5208d69d9afe0b53323e99a7');
	$new_arr[] = new \MongoId('563042a054fe0bd75d742c1c');
	$new_arr[] = new \MongoId('5707d58a54fe0bc472fcf165');
	$new_arr[] = new \MongoId('5208d6729afe0b53323e96a9');
	$new_arr[] = new \MongoId('564b4c0aa6ec6141791dcb82');
	$new_arr[] = new \MongoId('5653253b1f1d75d4610ecf58');
	$new_arr[] = new \MongoId('560eeacfa6ec61212d844087');
	$new_arr[] = new \MongoId('5213b60f9afe0b19277cdf6f');
	$new_arr[] = new \MongoId('5208d68a9afe0b53323e9853');
	$new_arr[] = new \MongoId('5626cd1d54fe0bfe71742c1d');
	$new_arr[] = new \MongoId('56675114a6ec61226cf351ac');
	$new_arr[] = new \MongoId('571ad0c854fe0b090d12cfc2');
	$new_arr[] = new \MongoId('5208d6419afe0b53323e9341');
	$new_arr[] = new \MongoId('562043d81f1d75102ac95844');
	$new_arr[] = new \MongoId('564d383e54fe0b4a63742c1c');
	$new_arr[] = new \MongoId('5620278a54fe0b280b742c1c');
	$new_arr[] = new \MongoId('56842411a6ec61b96e47bd10');
	$new_arr[] = new \MongoId('570848f5a6ec61ee66e12fd5');
	$new_arr[] = new \MongoId('5627a1711f1d751222131858');
	$new_arr[] = new \MongoId('562802afa6ec614a082aa5d1');
	$new_arr[] = new \MongoId('57278bc1a6ec61037bdd46c3');
	$new_arr[] = new \MongoId('5638c8e5a6ec619705e770ff');
	$new_arr[] = new \MongoId('56214cc21f1d75a839c95844');
	$new_arr[] = new \MongoId('57714ecba6ec61b62b06b97d');
	$new_arr[] = new \MongoId('56257dbc1f1d75b264131858');
	$new_arr[] = new \MongoId('562db29754fe0ba702742c1c');
	$new_arr[] = new \MongoId('56292fd0a6ec617f372aa5d1');
	$new_arr[] = new \MongoId('5208d6a49afe0b53323e9a1f');
	$new_arr[] = new \MongoId('570fe5d054fe0b5b3711ee6f');
	$new_arr[] = new \MongoId('5208d6349afe0b53323e9261');
	$new_arr[] = new \MongoId('561e74ffa6ec61ad2babe932');
	$new_arr[] = new \MongoId('5723b1161f1d7557539d8ea1');
	$new_arr[] = new \MongoId('5643b97754fe0bf852742c1c');
	$new_arr[] = new \MongoId('56254566a6ec6168302aa5d1');
	$new_arr[] = new \MongoId('561fc2da1f1d75473cc95845');
	$new_arr[] = new \MongoId('562808711f1d75ac7013185a');
	$new_arr[] = new \MongoId('5627f7cfa6ec61e57c2aa5d4');
	$new_arr[] = new \MongoId('5656750c54fe0b7d5f742c1c');
	$new_arr[] = new \MongoId('563ba9f31f1d75cb4b708f14');
	$new_arr[] = new \MongoId('5208d5e69afe0b53323e8cfb');
	$new_arr[] = new \MongoId('5682e34c1f1d75d22eaa2f52');
	$new_arr[] = new \MongoId('564b89dea6ec6141271dcb82');
	$new_arr[] = new \MongoId('563151951f1d75322f9ffbfc');
	$new_arr[] = new \MongoId('563d176fa6ec613b39e77101');
	$new_arr[] = new \MongoId('5208d5c19afe0b53323e8a65');
	$new_arr[] = new \MongoId('562818c41f1d751404131858');
	$new_arr[] = new \MongoId('5705461354fe0b2967fcf164');
	$new_arr[] = new \MongoId('562540141f1d751e30131859');
	$new_arr[] = new \MongoId('576423a854fe0b5d2b68c1b7');
	$new_arr[] = new \MongoId('5629232954fe0b5b40742c1c');
	$new_arr[] = new \MongoId('54c003ec1f1d759115070513');
	$new_arr[] = new \MongoId('5706c48054fe0bbd43fcf164');
	$new_arr[] = new \MongoId('56685e44a6ec61321af351ac');
	$new_arr[] = new \MongoId('562a4f321f1d757d59131858');
	$new_arr[] = new \MongoId('5625a87054fe0b3746742c1c');
	$new_arr[] = new \MongoId('564cebcfa6ec61cd731dcb82');
	$new_arr[] = new \MongoId('563d1215a6ec614335e770ff');
	$new_arr[] = new \MongoId('5208d5c99afe0b53323e8af3');
	$new_arr[] = new \MongoId('56266ad01f1d75b85a131858');
	$new_arr[] = new \MongoId('563bce5da6ec611079e770ff');
	$new_arr[] = new \MongoId('570ebc1f54fe0b726f11ee73');
	$new_arr[] = new \MongoId('54c90614a6ec614675fc6b49');
	$new_arr[] = new \MongoId('558724d31f1d75231f2c46f8');
	$new_arr[] = new \MongoId('537148d7a6ec614564632fc7');
	$new_arr[] = new \MongoId('5208d5f39afe0b53323e8ddc');
	$new_arr[] = new \MongoId('558c596ba6ec61b813a0dd0d');
	$new_arr[] = new \MongoId('5723591054fe0bea3f4b9606');
	$new_arr[] = new \MongoId('5620fc3a1f1d759703c95844');
	$new_arr[] = new \MongoId('562feb091f1d75a9689ffbfc');
	$new_arr[] = new \MongoId('571a98e1a6ec611f1d59229a');
	$new_arr[] = new \MongoId('57116755a6ec61a35a342067');
	$new_arr[] = new \MongoId('562945971f1d750262131858');
	$new_arr[] = new \MongoId('52b30ed91f1d75684fe537e2');
	$new_arr[] = new \MongoId('555f384b1f1d755e202c46f8');
	$new_arr[] = new \MongoId('5624f2b21f1d759272131858');
	$new_arr[] = new \MongoId('568ed3521f1d75591b772baf');
	$new_arr[] = new \MongoId('563ce93c1f1d754949708f14');
	$new_arr[] = new \MongoId('5678555b1f1d75b901630956');
	$new_arr[] = new \MongoId('56463cf754fe0b401b742c1c');
	$new_arr[] = new \MongoId('563367961f1d758d4e9ffbfc');
	$new_arr[] = new \MongoId('564a54e154fe0b1f64742c1c');
	$new_arr[] = new \MongoId('562501a61f1d75447c131858');
	$new_arr[] = new \MongoId('5630312254fe0b9155742c1d');
	$new_arr[] = new \MongoId('5208d5d69afe0b53323e8be1');
	$new_arr[] = new \MongoId('5208d5d39afe0b53323e8ba6');
	$new_arr[] = new \MongoId('5622cf7f54fe0b5313742c1c');
	$new_arr[] = new \MongoId('577589e21f1d75ff48d10528');
	$new_arr[] = new \MongoId('56328c1354fe0be122742c1c');
	$new_arr[] = new \MongoId('5648f648a6ec615d331dcb82');
	$new_arr[] = new \MongoId('562a74301f1d756675131858');
	$new_arr[] = new \MongoId('570feecb54fe0b2a3c11ee70');
	$new_arr[] = new \MongoId('5703e32354fe0bc022fcf164');
	$new_arr[] = new \MongoId('570fea54a6ec617453342067');
	$new_arr[] = new \MongoId('562561cfa6ec6197462aa5d1');
	$new_arr[] = new \MongoId('56946f2f54fe0b8f3dfc7173');
	$new_arr[] = new \MongoId('570d1816a6ec61a623342067');
	$new_arr[] = new \MongoId('563b93701f1d75c73d708f14');
	$new_arr[] = new \MongoId('5613d39c1f1d75dc442c46f9');
	$new_arr[] = new \MongoId('53a0873ba6ec61f911e40908');
	$new_arr[] = new \MongoId('5626a5b1a6ec61e41a2aa5d1');
	$new_arr[] = new \MongoId('57167d87a6ec61631659229a');
	$new_arr[] = new \MongoId('5208d6459afe0b53323e9391');
	$new_arr[] = new \MongoId('56211c5f54fe0b0d73742c1c');
	$new_arr[] = new \MongoId('54cff8f9a6ec61b970117b45');
	$new_arr[] = new \MongoId('5715497f54fe0b264312cfc2');
	$new_arr[] = new \MongoId('5626784154fe0b292e742c1d');
	$new_arr[] = new \MongoId('570553a11f1d75717a59eb47');
	$new_arr[] = new \MongoId('57068c1f1f1d75852959eb46');
	$new_arr[] = new \MongoId('54ca90e754fe0b730b708fac');
	$new_arr[] = new \MongoId('5759fccc1f1d756172782472');
	$new_arr[] = new \MongoId('5716781a1f1d759d5949b447');
	$new_arr[] = new \MongoId('56564a5954fe0bc34f742c1d');
	$new_arr[] = new \MongoId('5457bbb3a6ec611146523637');
	$new_arr[] = new \MongoId('570565f3a6ec611f16e12fd4');
	$new_arr[] = new \MongoId('5208d66d9afe0b53323e9654');
	$new_arr[] = new \MongoId('56268c0f54fe0bb63f742c1d');
	$new_arr[] = new \MongoId('5208d5c39afe0b53323e8a8a');
	$new_arr[] = new \MongoId('563908f71f1d75c34f708f16');
	$new_arr[] = new \MongoId('5626e5121f1d75d93b131858');
	$new_arr[] = new \MongoId('5717bcdb54fe0b715612cfc2');
	$new_arr[] = new \MongoId('5208d6279afe0b53323e917e');
	$new_arr[] = new \MongoId('57028fbf1f1d75fd3459eb46');
	$new_arr[] = new \MongoId('56290f4e1f1d757330131858');
	$new_arr[] = new \MongoId('570479c354fe0b5d46fcf164');
	$new_arr[] = new \MongoId('5208d5c59afe0b53323e8aac');
	$new_arr[] = new \MongoId('56842374a6ec61b96e47bd03');
	$new_arr[] = new \MongoId('5621095ba6ec613c7babe932');
	$new_arr[] = new \MongoId('562ad4391f1d75e72a131858');
	$new_arr[] = new \MongoId('560fec771f1d751e522c46f8');
	$new_arr[] = new \MongoId('5229e30b1f1d751e0a019bcb');
	$new_arr[] = new \MongoId('570559561f1d759d0e59eb4a');
	$new_arr[] = new \MongoId('560f443d1f1d75e2182c46f8');
	$new_arr[] = new \MongoId('5624f58754fe0b912e742c1e');
	$new_arr[] = new \MongoId('5208d6569afe0b53323e94bf');
	$new_arr[] = new \MongoId('568eaa1c1f1d751679772bac');
	$new_arr[] = new \MongoId('5622a72da6ec61315fabe933');
	$new_arr[] = new \MongoId('5660b12554fe0b3034742c1c');
	$new_arr[] = new \MongoId('5633009154fe0b8666742c1d');
	$new_arr[] = new \MongoId('57309ba1a6ec61b81bf9db0e');
	$new_arr[] = new \MongoId('5626f084a6ec613c4a2aa5d1');
	$new_arr[] = new \MongoId('566e32b4a6ec61c377dfe077');
	$new_arr[] = new \MongoId('563933afa6ec612c5de77100');
	$new_arr[] = new \MongoId('561e9b3b54fe0b8c49742c1e');
	$new_arr[] = new \MongoId('57164ba5a6ec61ba6359229a');
	$new_arr[] = new \MongoId('5676e6441f1d75bc50630957');
	$new_arr[] = new \MongoId('570c46cd54fe0b8a5a11ee6f');
	$new_arr[] = new \MongoId('5208d6ad9afe0b53323e9ac2');
	$new_arr[] = new \MongoId('56ffc8f2a6ec61180c0c4e84');
	$new_arr[] = new \MongoId('53dfc50554fe0b7e17dade9e');
	$new_arr[] = new \MongoId('570d05841f1d758517d3b36b');
	$new_arr[] = new \MongoId('564612451f1d75f9754b0ce8');

    $memberObj = new Model\Member($doc=array(), $app);    
    $members = $memberObj->find(array('_id'=>array('$in'=>$new_arr)),$fields=array(),true,$sort=array(),0,10000);
