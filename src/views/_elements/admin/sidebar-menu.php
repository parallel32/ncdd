   ...
   <!-- BEGIN SIDEBAR -->
      <div class="page-sidebar nav-collapse collapse">
         ...
         <? if($accessLevel >= EDITOR):?>
            <li class="start <? echo ($this->vars['active'] == 'Announcement') ? 'active':'';?>">
               <a href="/page/announcements">
               <i class="icon-bullhorn"></i> 
               <span class="title">Announcements</span>
               <? echo ($this->vars['active'] == 'Announcement') ? '<span class="selected"></span>':'';?>
               </a>
            </li>
            ...
            <li class="<? echo (strpos($this->vars['active'], 'Application') !== false) ? 'active open':'open';?>">
               ...
               <ul class="sub-menu" style="display: block;">
                  ...
                  <li class="<? echo ($this->vars['active'] == 'Applications/RenewalAuto') ? 'active':'';?>">
                     <a href="/renewalsauto"><i class="icon-file-text"></i> Renewals - Auto</a>
                  </li>
         ...
         <? if($accessLevel >= MEMBER && !$this->app['renewal_payment_failure']()):?>
            <li class="<? echo (strpos($this->vars['active'], 'Members') !== false) ? 'active open':'';?>">
               ...
               <ul class="sub-menu">
                  ...
                  <li class="<? echo ($this->vars['active'] == 'Members/src') ? 'active':'';?>">
                     <a href="/member/search?query=Experts"><i class="icon-user"></i> Experts</a>
                  </li>
               </ul>
            </li>
         <? endif; ?>
