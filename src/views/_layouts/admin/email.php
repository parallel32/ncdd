...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<title>NCDD Member Portal | Email Notification</title>
		<style type="text/css">
	...
	<body>
		...
		<?=$this->content($view)?>
		<table border="0" cellpadding="0" cellspacing="0" width="100%" style="background-color:#DFD9D9;">
			<tr>
				<td align="center">
					<center>
						<table border="0" cellpadding="0" cellspacing="0" width="600px" style="height:100%;">
							<tr>
								<td align="right" valign="middle" class="" style="font-size:12px;padding:20px;">
