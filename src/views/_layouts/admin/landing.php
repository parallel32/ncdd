	...
	<div class="header navbar navbar-inverse navbar-fixed-top">
		...
		<div class="navbar-inner">
			<div class="container">
				...
				<img src="<?=SAW_SSL_CDN?>/assets/img/logo.png" alt="logo" />
				</a>
				<!-- END LOGO -->
				...
				<ul class="nav pull-right">
					...
					<li class="dropdown user">
						<a href="#" class="dropdown-toggle" data-toggle="dropdown">
						<img alt="" src="<?=SAW_SSL_CDN?>/assets/img/avatar1_small.jpg" />
										...
										<div class="active item">
											<div class="row-fluid">
												...
												<div class="span5 animated rotateInDownLeft">
													<a href="index.html"><img src="<?=SAW_SSL_CDN?>/assets/img/pages/img1.png" alt=""></a>
												</div>
											</div>
										</div>
										<div class="item">
											<div class="row-fluid">
												<div class="span5 animated rotateInUpRight">
													<a href="index.html"><img src="<?=SAW_SSL_CDN?>/assets/img/pages/img1_2.png" alt=""></a>
												</div>
							...
							<div class="container">
								<div class="row-fluid">
									<div class="span5 margin-bottom-20">
										<a href="index.html"><img src="<?=SAW_SSL_CDN?>/assets/img/pages/img2.png" alt=""></a>
									</div>
									<div class="span7">
						...
						<div class="block-transparent">
							<div class="container">
								<div class="row-fluid margin-bottom-20">
									...
									<div class="span6 margin-bottom-20">
										<a href="index.html"><img src="<?=SAW_SSL_CDN?>/assets/img/pages/img3.png" alt=""></a>
									</div>
								</div>
								<div class="row-fluid">
									<div class="span6">
										<a href="index.html"><img src="<?=SAW_SSL_CDN?>/assets/img/pages/img4.png" alt=""></a>
									</div>
									<div class="span6 margin-bottom-20">
								...
								<div class="row-fluid">
									...
									<div class="span4">
										...
										<ul class="unstyled blog-images">
											<li><a href="#"><img src="<?=SAW_SSL_CDN?>/assets/img/blog/1.jpg" alt=""></a></li>
											<li><a href="#"><img src="<?=SAW_SSL_CDN?>/assets/img/blog/2.jpg" alt=""></a></li>
											<li><a href="#"><img src="<?=SAW_SSL_CDN?>/assets/img/blog/3.jpg" alt=""></a></li>
											<li><a href="#"><img src="<?=SAW_SSL_CDN?>/assets/img/blog/4.jpg" alt=""></a></li>
											<li><a href="#"><img src="<?=SAW_SSL_CDN?>/assets/img/blog/5.jpg" alt=""></a></li>
											<li><a href="#"><img src="<?=SAW_SSL_CDN?>/assets/img/blog/6.jpg" alt=""></a></li>
											<li><a href="#"><img src="<?=SAW_SSL_CDN?>/assets/img/blog/8.jpg" alt=""></a></li>
											<li><a href="#"><img src="<?=SAW_SSL_CDN?>/assets/img/blog/10.jpg" alt=""></a></li>
											<li><a href="#"><img src="<?=SAW_SSL_CDN?>/assets/img/blog/11.jpg" alt=""></a></li>
											<li><a href="#"><img src="<?=SAW_SSL_CDN?>/assets/img/blog/1.jpg" alt=""></a></li>
											<li><a href="#"><img src="<?=SAW_SSL_CDN?>/assets/img/blog/2.jpg" alt=""></a></li>
											<li><a href="#"><img src="<?=SAW_SSL_CDN?>/assets/img/blog/7.jpg" alt=""></a></li>
										</ul>
									</div>
									<div class="span4">
										<h3>Stay Tuned</h3>
