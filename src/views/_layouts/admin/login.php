...
<head>
  ...
  <script type="text/javascript"> 
    var $buoop = {vs:{i:9,f:20,o:11,s:5,n:9},reminder:0/*,test:true*/} 
...
<body class="login">
    ...
    <form class="form-vertical register-form">
      ...
      <div class="control-group">
        ...
        <div class="controls">
          <div class="input-icon left">
            <i class="icon-lock"></i>
            <input class="m-wrap placeholder-no-fix password" type="password" id="register_password" placeholder="Password" name="doc[password]"/>
          </div>
        </div>
      </div>
      <div class="control-group">
        ...
        <div class="controls">
          <div class="input-icon left">
            <i class="icon-ok"></i>
            <input class="m-wrap placeholder-no-fix rpassword" type="password" placeholder="Re-type Your Password" name="doc[rpassword]"/>
          </div>
        </div>
      </div>
      <div class="control-group">
        <div class="controls">
          <label class="checkbox">
          <input type="checkbox" name="doc[tnc]"/> I agree to the <a href="#">Terms of Service</a> and <a href="#">Privacy Policy</a>
          </label>  
  ...
  <?=$this->element('js/FormControlsLogin.js');?>
