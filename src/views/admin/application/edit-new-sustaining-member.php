            ...
            <div class="span12">
               ...
               <form id="saw-form" class="horizontal-form portlet">
                  ...
                  <div class="row-fluid addr ">
                     <div class="span6 ">
                        <div class="control-group">
                           ...
                           <div class="controls">
                              <input type="text" id="zip" name="doc[postalCode]" value="<?if(strlen($this->vars['application']['postalCode']) < 5){echo str_pad($this->vars['application']['postalCode'],5,'0',STR_PAD_LEFT);}else if(strlen($this->vars['application']['postalCode']) > 5 && strlen($this->vars['application']['postalCode']) < 9){str_pad($this->vars['application']['postalCode'],9,'0',STR_PAD_LEFT);}else{echo $this->vars['application']['postalCode'];}?>" class="m-wrap span12 postalCode"> 
                           </div>
                        </div>
                     </div>
                     <!--/span-->
                  ...
                  <div class="row-fluid">
                     <div class="span12">
                        <p>
                           I, <input class="m-wrap span3 acknowledgePrintedName" type="text" placeholder="<print your name here>" value="<?=$this->vars['application']['authorizationReleasePrintedName']?>"> 
