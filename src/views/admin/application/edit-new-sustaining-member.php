                  ...
                  <div class="row-fluid">
                        ...
                        <div class="control-group">
                           ...
                           <div class="controls">
                              <select class="small m-wrap attendSeminar" name="doc[attendSeminar]">
                                 <option<?=($this->vars['application']['attendSeminar'] == "no") ? ' selected' :'';?> value="no">No</option>
                                 <option<?=($this->vars['application']['attendSeminar'] == "yes") ? ' selected' :'';?> value="yes">Yes</option>
                              </select>
                           </div>
                        </div>
                     </div>
                     ...
                     <div class="span6 ">
                        <div class="control-group">
                           <label class="control-label">If "Yes", please explain.</label>
                           <div class="controls">
                              <textarea class="span12 attendSeminarExplain" name="doc[attendSeminarExplain]"><?=$this->vars['application']['attendSeminarExplain']?></textarea>
                           </div>
                        </div>
                     </div>
                     <!--/span-->
