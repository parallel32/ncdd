                     ...
                     <div class="span12 ">
                        <div class="control-group">
                           ...
                           <div class="controls">
                              ...
                              <input style="margin-left:1px;" <?=(array_key_exists('payByCheck',$this->vars['application'])) ? (strpos($this->vars['application']['payByCheck'], 'no') !== false) ? ' checked' :'' : '';?> type="radio" name="doc[payByCheck]" value="no">&nbsp;&nbsp;No, I intend to pay my membership dues online with my credit card.<br/><br/>
