                  ...
                  <div class="row-fluid">
                     <div class="span6 ">
                        <div class="control-group">
                           ...
                           <div class="controls">
                              <input type="text" name="doc[postalCode]" value="<?if(!empty($this->vars['application']['postalCode']) && strlen($this->vars['application']['postalCode']) < 5){echo str_pad($this->vars['application']['postalCode'],5,'0',STR_PAD_LEFT);}else if(strlen($this->vars['application']['postalCode']) > 5 && strlen($this->vars['application']['postalCode']) < 9){str_pad($this->vars['application']['postalCode'],9,'0',STR_PAD_LEFT);}else{echo $this->vars['application']['postalCode'];}?>" class="m-wrap span12 postalCode">
                           </div>
                        </div>
                     </div>
                     <!--/span-->
                  ...
                  <div class="row-fluid">
                     <div class="span6">
                        <div class="control-group ">
                           ...
                           <div class="controls">
                              <input type="text" name="doc[renewalpromocode]" class="m-wrap span12 renewalpromocode" value="<?=(array_key_exists('renewalpromocode',$this->vars['application'])) ? $this->vars['application']['renewalpromocode']: ''?>">
                  ...
                  <div id="paybycheck" class="row-fluid">
                     <div class="span12 alert alert-warning">
                        <div class="control-group error">
                           <label class="control-label"></label>
                           <div class="controls">
                              <input class="payByCheck" style="margin-left:1px;" <?=(array_key_exists('payByCheck',$this->vars['application'])) ? ($this->vars['application']['payByCheck'] == "yes") ? ' checked' :'' : '';?> type="radio" name="doc[payByCheck]" value="yes">&nbsp;&nbsp;Yes, I intend to pay my membership dues by check.<br/><br/>
                              <input class="payByCheck" style="margin-left:1px;" <?=(array_key_exists('payByCheck',$this->vars['application'])) ? (strpos($this->vars['application']['payByCheck'], 'no') !== false) ? ' checked' :'' : '';?> type="radio" name="doc[payByCheck]" value="no">&nbsp;&nbsp;No, I intend to pay my membership dues online with my credit card.<br/><br/>
                              <!--<input style="margin-left:1px;" <?=(array_key_exists('payByCheck',$this->vars['application'])) ? ($this->vars['application']['payByCheck'] == "no-store") ? ' checked' :'' : '';?> type="radio" name="doc[payByCheck]" value="no-store">&nbsp;&nbsp;No, I intend to pay my membership dues online with my credit card.I intend to pay my membership dues online with my credit card.  Please also store my credit card for future convenience.<br/><br/>-->
