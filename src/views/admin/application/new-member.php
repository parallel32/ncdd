         ...
         <div class="row-fluid">
            <div class="span12">
               ...
               <form id="saw-form" class="horizontal-form portlet">
                  ...
                  <!-- BEGIN ADDRESS MODAL -->
                  <div id="address_modal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="save-success-label" aria-hidden="true">
                     <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
                        <h3 id="save-success-label">Select the Address</h3>
                  ...
                  <div class="row-fluid">
                     <div class="span12 ">
                        <div class="control-group">
                           ...
                           <div class="controls">
                              <select class=" m-wrap span12 everLawEnforcement" name="doc[everLawEnforcement]">
