                  ...
                  <div class="row-fluid">
                     <div class="span6 ">
                        <div class="control-group">
                           ...
                           <div class="controls">
                              <input disabled type="text" name="doc[postalCode]" value="<?if(!empty($this->vars['application']['postalCode']) && strlen($this->vars['application']['postalCode']) < 5){echo str_pad($this->vars['application']['postalCode'],5,'0',STR_PAD_LEFT);}else if(strlen($this->vars['application']['postalCode']) > 5 && strlen($this->vars['application']['postalCode']) < 9){str_pad($this->vars['application']['postalCode'],9,'0',STR_PAD_LEFT);}else{echo $this->vars['application']['postalCode'];}?>" class="m-wrap span12 postalCode">
                           </div>
                        </div>
                     </div>
                     <!--/span-->
                     ...
                     <div class="span12 ">
                        <div class="control-group">
                           ...
                           <div class="controls">
                              ...
                              foreach ($this->vars['application']['websites'] as $website) {
                                 echo "<tr><td><input disabled type='text' name='doc[websites][".$i."][website]' value='".$website['website']."' class='m-wrap span12'></td><td><input disabled type='text' name='doc[websites][".$i."][websiteDesc]' value='".$website['websiteDesc']."' class='m-wrap span12'></td></tr>";
                                 $i++;
                              }
                              endif;
                              ?>
