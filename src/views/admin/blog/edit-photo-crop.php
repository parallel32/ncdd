               ...
               <div class="span12">
                  ...
                  <div class="portlet box blue">
                     <div class="portlet-title">
                        <div class="caption"><i class="icon-picture"></i>Crop Blog Image</div>
                       <div class="actions">
                     ...
                     <div class="portlet-body form">
                      <div class="well">
                       ...
                       <form id="saw-form" class="horizontal-form">
                          <input type="hidden" name="doc[belongsTo]" value="<?=$blog['_id']?>">
                          <input type="hidden" name="doc[context]" value="blog">
                          <input type="hidden" name="doc[size]" value="large">
                          <input type="hidden" name="doc[imageId]" value="<?=$blog['image']['sizes']['large']['id']?>">
