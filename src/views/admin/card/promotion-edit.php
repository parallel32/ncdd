            ...
            <div class="span12">
               ...
               <form id="saw-form" class="horizontal-form portlet">
                  ...
                  background-image: url('/assets/img/card-discover.gif');
                     ...
                     <input type="hidden" class="id" name="doc[id]" value="<?=(!empty($this->vars['id'])) ? $this->vars['id'] : ''?>">
                     <input type="hidden" class="status" name="doc[status]" value="<?=(!empty($this->vars['status'])) ? $this->vars['status'] : ''?>">
...
jQuery(document).ready(function() {    
   ...
   cardSave = function (){
      ...
      io.saw.FormPost.activate({postUrl:'/card/promotion/edit'
