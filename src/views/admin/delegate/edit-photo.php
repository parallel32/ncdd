...
<!-- BEGIN PAGE -->
               ...
               <div class="span12">
                  ...
                  <div class="portlet box blue">
                     <div class="portlet-title">
                        <div class="caption"><i class="icon-picture"></i>Edit Delegate Image</div>
                       <div class="actions">
                     ...
                     <div class="portlet-body form">
                       ...
                       <form id="fileupload" action="#" method="POST" enctype="multipart/form-data">
                          <input type="hidden" name="doc[belongsTo]" value="<?=$delegate['_id']?>">
                          <input type="hidden" name="doc[context]" value="delegate">
                          <input type="hidden" name="doc[parentAttr]" value="<?=$this->vars['parentAttr']?>">
      ...
      jQuery(document).ready(function() {   
        ...
        $('.yellow.image').click(function(e){
            document.location.href='/delegate/edit/<?=$delegate['_id']?>/edit-photo-crop/<?=$this->vars['parentAttr']?>';
        }); 
        $('.back.image').click(function(e){
          document.location.href='/delegate/edit/<?=$delegate['_id']?>';
        }); 
        $('.red.image').click(function(e){
          io.saw.FormGet.activate({postUrl:"<?=(array_key_exists('imageDelete',$this->vars)) ? $this->vars['imageDelete']: '';?>"
            ...
            ,postOnSuccess:function(responseObj){
              document.location.href='/delegate/edit/<?=$delegate['_id']?>/edit-photo/<?=$this->vars['parentAttr']?>';
            }
          });
        }); 
