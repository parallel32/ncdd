...
<br/><br/>
<a href="http://<?=SAW_ADMIN_WEBSITE?>/application/downloads/ncdd-general-membership-reference-form.pdf" target="_blank">Click here to download the reference form</a>. 
<br><br>
