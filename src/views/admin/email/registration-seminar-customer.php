...
<table>
	...
	<? if((array_key_exists('register',$this->vars['seminar']) && array_key_exists('rsvpKidsQuestion',$this->vars['seminar']['register']) && $this->vars['seminar']['register']['rsvpKidsQuestion'] == 'ON') ): ?>
	<tr><td><strong>Children Attendees Dinner RSVP:</strong></td><td><?=(array_key_exists('rsvpkids',$this->vars)) ? $this->vars['rsvpkids'] : 0?></td></tr>
	<? endif; ?>
	<? endif; ?>
