							...
							<tr>
								<td valign="top" class="bodyContent">
									<table border="0" cellpadding="20" cellspacing="0" width="100%">
										<tr>
											<td valign="top">
												<h2 class="h2">NCDD Sustaining Membership Update Approved</h2>
												<br />
												<div class="textdark">
Dear <?=$this->vars['name']?>, your application to update your membership as a Sustaining Member has been approved.
<br/>
