   ...
   <form id="saw-form" class="form-horizontal" novalidate="novalidate">
      <input type="hidden" name="doc[message]" value="The page you're accessing requires authentication.  Please sign-in and you will be redirected back to the page you requested.">
