...
<!-- BEGIN PAGE -->
               ...
               <div class="span12">
                  ...
                  <div class="portlet box blue">
                     <div class="portlet-title">
                        <div class="caption"><i class="icon-picture"></i>Edit Forum Image</div>
                       <div class="actions">
                     ...
                     <div class="portlet-body form">
                       ...
                       <form id="fileupload" action="#" method="POST" enctype="multipart/form-data">
                          <input type="hidden" name="doc[belongsTo]" value="<?=$forum['_id']?>">
                          <input type="hidden" name="doc[context]" value="forum">
      ...
      jQuery(document).ready(function() {   
        ...
        $('.yellow.image').click(function(e){
            document.location.href='/forum/edit/<?=$forum['_id']?>/edit-photo-crop';
        }); 
        $('.back.image').click(function(e){
          document.location.href='/forum/edit/<?=$forum['_id']?>';
        }); 
        $('.red.image').click(function(e){
          io.saw.FormGet.activate({postUrl:"<?=(array_key_exists('imageDelete',$this->vars)) ? $this->vars['imageDelete']: '';?>"
            ...
            ,postOnSuccess:function(responseObj){
              document.location.href='/forum/edit/<?=$forum['_id']?>/edit-photo';
            }
          });
        }); 
