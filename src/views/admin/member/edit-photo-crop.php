               ...
               <div class="span12">
                  ...
                  <div class="portlet box blue">
                     <div class="portlet-title">
                        <div class="caption"><i class="icon-picture"></i>Crop Member Image</div>
                       <div class="actions">
                     ...
                     <div class="portlet-body form">
                      <div class="well">
                       ...
                       <form id="saw-form" class="horizontal-form">
                          ...
                          <input type="hidden" name="doc[size]" value="small">
                          <input type="hidden" name="doc[imageId]" value="<?=$member['image']['sizes']['small']['id']?>">
