...
<!-- BEGIN PAGE -->
               ...
               <div class="span12">
                  ...
                  <div class="portlet box blue">
                     <div class="portlet-title">
                        <div class="caption"><i class="icon-picture"></i>Edit Member Image</div>
                       <div class="actions">
                          <a class="btn red image <?=($this->vars['image'] == '/noprofileimage') ? 'hide' :'' ?>"> Delete This Image</a>
                          <a class="btn yellow image <?=($this->vars['image'] == '/noprofileimage') ? 'hide' :'' ?>"> Crop This Image</a>
                     ...
                     <div class="portlet-body form">
                       ...
                       <form id="fileupload" action="#" method="POST" enctype="multipart/form-data">
                          <input type="hidden" name="doc[belongsTo]" value="<?=$member['_id']?>">
                          <input type="hidden" name="doc[context]" value="member">
      ...
      jQuery(document).ready(function() {   
        ...
        $('.yellow.image').click(function(e){
            document.location.href='/member/<?=$member['_id']?>/edit-photo-crop';
        }); 
        $('.back.image').click(function(e){
          document.location.href='/member/<?=$member['_id']?>/edit';
        }); 
        $('.red.image').click(function(e){
          io.saw.FormGet.activate({postUrl:"<?=(array_key_exists('imageDelete',$this->vars)) ? $this->vars['imageDelete']: '';?>"
            ...
            ,postOnSuccess:function(responseObj){
              document.location.href='/member/<?=$member['_id']?>/edit-photo';
            }
          });
        }); 
