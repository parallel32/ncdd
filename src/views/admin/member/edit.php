                  ...
                  <div class="span12">
                     <form id="saw-form" class="horizontal-form portlet">
                        ...
                        <div class="row-fluid">
                           <div class="span6 ">
                              <div class="control-group ">
                                 <label class="control-label">Contributed Sustaining Member?</label>
                                 <div class="controls">
                                    <select class="small m-wrap contributedSustainingMember" name="doc[contributedSustainingMember]">
                                       <option value="no">No</option>
                                       <option value="yes" <?=(array_key_exists('contributedSustainingMember',$this->vars['member'])) ? ($this->vars['member']['contributedSustainingMember'] == 1) ?'selected':'': '';?>>Yes</option>
                                    </select>
                                 </div>
                              </div>
                           </div>
                           ...
                           <div class="span6 ">
                              <div class="control-group ">
                                 ...
                                 <div class="controls">
                                    ...
                                    <? endif; ?>
                                    <? if(array_key_exists('contributedSustainingMember',$this->vars['member']) && $this->vars['member']['contributedSustainingMember']): ?>
                                       &nbsp;&nbsp;<img width="152" src="<?=SAW_PUBLIC_SSL_CDN?>/badge/<?=$this->vars['member']['_id']?>/contributedSustainingMember">
                                    <? endif; ?>
                                 </div>
                              </div>
                           </div>
                        ...
                        <div class="row-fluid">
                           <div class="span6 ">
                              <div class="control-group ">
                                 <label class="control-label">Contributed Sustaining Member Badge for your website:</label>
                                 <div class="controls">
                                    <textarea rows="3" class="span8"><a target="_blank" href="https://<?=SAW_CONSUMER_WEBSITE?>/member/<?=$this->vars['member']['_id']?>/<?=$this->vars['member']['slug']?>"><img width="152" src="<?=SAW_PUBLIC_SSL_CDN?>/badge/<?=$this->vars['member']['_id']?>/contributedSustainingMember" alt="NCDD National College for DUI Defense: <?=$this->vars['member']['firstName']?><?=(array_key_exists('middleName',$this->vars['member']) && !empty($this->vars['member']['middleName'])) ? ' '.$this->vars['member']['middleName'].' ':' ';?><?=$this->vars['member']['lastName']?>" title="NCDD National College for DUI Defense: <?=$this->vars['member']['firstName']?><?=(array_key_exists('middleName',$this->vars['member']) && !empty($this->vars['member']['middleName'])) ? ' '.$this->vars['member']['middleName'].' ':' ';?><?=$this->vars['member']['lastName']?>" /></a></textarea>
                                 </div>
                              </div>
                           </div>
                           <!--/span-->
