                  ...
                  <div class="row-fluid">
                     <div class="span12 ">
                        <div class="control-group">
                           <div class="controls">
                              <input type="text" value="https://<?=SAW_ADMIN_WEBSITE?>/reference/<?=$this->vars['reference']['_id']?>/view-public" class="m-wrap span12">
                           </div>
                        </div>
                     </div>
                     <!--/span-->
...
Governing, <b>SUSTAINING MEMBERSHIP</b> as adopted and approved by the National College for DUI Defense, Inc.
                  ...
                  <div class="form-actions text-center">
                     <a href="/application/<?=$this->vars['application']['_id']?>/view" class="btn go-back">Go Back</a>
                  </div>
               </form>
               <!-- END FORM--> 
            </div>
