                  ...
                  <div class="row-fluid ">
                     <div class="span12 ">
                        <div class="control-group">
                           ...
                           <div class="controls">
                              <input type="text" name="doc[rsvp]" value="<?=$this->vars['registration']['rsvp']?>" class="m-wrap span12 rsvp"> 
                           ...
                           <div class="controls">
                              <div class="input-prepend input-append">
                                  <span class="add-on">$ </span>
                                     <input id="registration_fee" value="<?=$this->vars['registration']['registrationFee']?>" type="text" disabled value="" class="m-wrap span12"> 
