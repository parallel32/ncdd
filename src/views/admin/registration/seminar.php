               ...
               <form id="saw-form" class="horizontal-form portlet">
                  ...
                  <? if($this->vars['activate_waitlist'] == false): ?>
                     ...
                     <div class="row-fluid addr ">
                        ...
                        <div class="span6 ">
                           <div class="control-group">
                              <label class="control-label" >Would you like to pre-order a hard copy of the materials? <br>(Materials will already be provided on a thumb drive in your seminar package on-site, which is already included in the cost of registration)</label>
                              <div class="controls">
