...
<!-- BEGIN PAGE -->
               ...
               <div class="span12">
                  ...
                  <div class="portlet box blue">
                     <div class="portlet-title">
                        <div class="caption"><i class="icon-picture"></i>Edit Seminar Image</div>
                       <div class="actions">
      ...
      jQuery(document).ready(function() {   
        ...
        $('.yellow.image').click(function(e){
            document.location.href='/seminar/edit/<?=$seminar['_id']?>/edit-photo-crop';
        }); 
        $('.back.image').click(function(e){
          document.location.href='/seminar/edit/<?=$seminar['_id']?>';
        }); 
        $('.red.image').click(function(e){
          io.saw.FormGet.activate({postUrl:"<?=(array_key_exists('imageDelete',$this->vars)) ? $this->vars['imageDelete']: '';?>"
            ...
            ,postOnSuccess:function(responseObj){
              document.location.href='/seminar/edit/<?=$seminar['_id']?>/edit-photo';
            }
          });
        }); 
