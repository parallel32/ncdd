<? $stateseminar = $this->vars['stateseminar']; ?>
<!-- BEGIN PAGE -->
                  ...
                  <div class="portlet box blue">
                     ...
                     <div class="portlet-body form">
                       ...
                       <form id="fileupload" action="#" method="POST" enctype="multipart/form-data">
                          <input type="hidden" name="doc[belongsTo]" value="<?=$stateseminar['_id']?>">
                          <input type="hidden" name="doc[context]" value="stateseminar">
      ...
      jQuery(document).ready(function() {   
        ...
        $('.yellow.image').click(function(e){
            document.location.href='/stateseminar/edit/<?=$stateseminar['_id']?>/edit-photo-crop';
        }); 
        $('.back.image').click(function(e){
          document.location.href='/stateseminar/edit/<?=$stateseminar['_id']?>';
        }); 
        $('.red.image').click(function(e){
          io.saw.FormGet.activate({postUrl:"<?=(array_key_exists('imageDelete',$this->vars)) ? $this->vars['imageDelete']: '';?>"
            ...
            ,postOnSuccess:function(responseObj){
              document.location.href='/stateseminar/edit/<?=$stateseminar['_id']?>/edit-photo';
            }
          });
        }); 
