         ...
         <div class="container-fluid">
            ...
            <div class="row-fluid">
              <div class="span12">
                ...
                <div id="page">
                      <textarea id="_content" name="content" style="height: 560px;"></textarea>
                </div>
                ...
                jQuery(document).ready(function() {  
                  ...
                  theeditor = tinymce.init({
                      ...
                      ,plugins: "ncddcustom code link image textcolor charmap pagebreak fullscreen preview paste"
                      ,toolbar1: "bold italic strikethrough bullist numlist blockquote alignleft aligncenter alignright link unlink preview fullscreen | undo redo code"
                      ,toolbar2: "underline alignjustify textcolor removeformat charmap outdent indent cut copy paste formatselect fontsizeselect styleselect"
                      ,toolbar3: "saw-blockquote saw-well saw-vfl saw-embed-media saw-embed-website saw-embed-photo saw-embed-file"
