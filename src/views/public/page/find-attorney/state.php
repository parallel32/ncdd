...
<script src="/assets/js/Bebas_Neue_400.font.js" type="text/javascript"></script>
<script src="/assets/js/Ubuntu_Condensed_400.font.js" type="text/javascript"></script>
<script src="/assets/js/Bree_Serif_400.font.js" type="text/javascript"></script>
                            ...
                            <div class=" tc searchresultswrap">
                                ...
                                <div class="row-fluid searchmeta">
                                    ...
                                    <div class="span5 tc">
                                        ...
                                        <img class="sheild" width="100" src="http://<?=SAW_CONSUMER_WEBSITE?>/badge/<?=$member['_id']?>/boardcertified" alt="NCDD National College for DUI Defense: <?=$member['firstName']?><?=$middleName?><?=$member['lastName']?>" title="NCDD National College for DUI Defense: <?=$member['firstName']?><?=$middleName?><?=$member['lastName']?>" />
                                        <? endif; ?>
                                    </div>
                                    <div class="span4 bc">
