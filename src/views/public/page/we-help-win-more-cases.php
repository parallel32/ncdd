...
.content .title h2, .content .title h3 {    border-top: 1px solid #d1dbe1;    color: #c2d2dc;    text-shadow: 0 -1px 0 #53778D,0 -2px 0 #53778D,0 1px 0 #53778D,1px 0 0 #53778D,1px 1px 0 #53778D,1px -2px 0 #53778D,0 2px 0 white;    letter-spacing: 1px;    z-index: 10;    position: relative;    margin: 0;}
        ...
        <div class="row-fluid becomeAmember">
            <div class="title text-center">
                ...
                <div class="quiz pad30">
                    ...
                    <div class="row">
                        <a href="https://<?=SAW_CONSUMER_WEBSITE?>/we-help-win-more-cases-answers"><img src="/assets/img/button-click-answers.png" class="applyBtn"></a>
                    </div>
                    <div class="row">
