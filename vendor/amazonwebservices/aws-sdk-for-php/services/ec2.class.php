...
class AmazonEC2 extends CFRuntime
{
	 ...
	 * @return CFResponse A <CFResponse> object containing a parsed HTTP response.
	 */
	public function disable_vSAW_route_propagation($route_table_id, $gateway_id, $opt = null)
	{
		if (!$opt) $opt = array();
		$opt['RouteTableId'] = $route_table_id;
	 ...
	 * @return CFResponse A <CFResponse> object containing a parsed HTTP response.
	 */
	public function enable_vSAW_route_propagation($route_table_id, $gateway_id, $opt = null)
	{
		if (!$opt) $opt = array();
		$opt['RouteTableId'] = $route_table_id;
		$opt['GatewayId'] = $gateway_id;
