...

	{
...

		{
			...
			{	
				...
				wp_enqueue_style(  'themeple_custom_menu', THEME_PATH . '/extension/system/css/themeple_custom_menu.css');

				wp_enqueue_script( 'themeple_custom_menu' , THEME_PATH . '/extension/system/js/themeple_custom_menu.js',array('jquery', 'jquery-ui-sortable'), false, true );
...
//				$attributes  = ! empty( $item->attr_title ) ? ' title="'  . esc_attr( $item->attr_title ) .'"' : '';
				...
				$item_output .= '<a'. $attributes .'><i class=" fa '.$item->attr_title.'"></i>';
